set log file fv/c17/rtl_to_g1.log -replace
...
usage -auto -elapse
// tclmode
// set env(CDN_SYNTH_ROOT) /cadence/EDI/tools.lnx86
// vpxmode

tclmode
puts "Start: Reading OVF file"
vpx read guide file fv/c17/rtl_to_g1.ovf
...
add search path -library /cadence/GPDK/osu_stdcells/lib/tsmc018/signalstorm
...
elaborate design -golden -root c17 -rootonly

read design -verilog -revised -lastmod -noelab \
	-unzip fv/c17/g1.v.gz

elaborate design -revised -root c17
